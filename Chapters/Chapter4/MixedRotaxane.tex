...
\begin{wrapfigure}[22]{r}{0.5\textwidth}
  ...
  \begin{center}
    ...
    \caption[Figure of the simulated mixed rotaxanes.]{The different mixed rotaxane
    versions that are simulated. The label above the rotaxanes refers to the number of
    nucleotides (nt) that are present in the corresponding DNA strand.}
  \label{fig:mixed}
\end{center}
\end{wrapfigure}
...
\begin{figure}[ht!]
  ...
  \end{centering}
  \caption[short lof/lot caption]{\linespread{0.5}{\small(a) Experimental I-V curves for
the mixed rotaxane, with varying ssDNA lengths (0−40 nt, from top to bottom). The
electrical recordings were carried out in 2 M NaCl, 15 mM Tris-HCl, pH 7.5, at 22 °C.
Data were recorded by applying a 10 kHz low-pass filter. (b) Simulated time traces of the
reaction coordinate, (Eq. S1), of the ?? trans neutravidin for 5 different ssDNA lengths
of the mixed rotaxane (0−40 nt, from top to bottom). The average values (standard
deviations) are ―13.2 (5.0) nm , ―11.8 (4.4) nm ―10.5 (3.8) nm ―11.0 (3.5) nm and ―11.6
(3.7) nm , from top to, , bottom, respectively. The associated histograms are plotted
next to the traces. The horizontal red line indicates the ?? value of the pore
trans-entry. A typical configuration for each rotaxane is shown in (c).}}
\end{figure}
...
In Figure \ref{fig:mixedrotaxane}a, the measured time trace of the $X$-coordinate is
presented for each mixed
...
\subsection{Rotaxane and 1d Diffusion}
...
trans-stopper is determined within a range of time intervals.\footnote{The Tidynamics
  package was used for an efficient calculation of the MSE. \cite{deBuyl2018}}
  Calculating the MSD is done by utilising
a rolling-window
