...
\begin{figure}[ht]
  ...
  \begin{subfigure}[t]{\dimexpr.44\linewidth-1.3em\relax}
  \centering
  \includegraphics[width=0.9\linewidth,valign=t]{Figures/Stefanos2.png}
  \end{subfigure}
  \caption[]{\linespread{0.1}{\small The bead-and-spring coarse-grained model used for
  simulating the DNA nanopiston. (a) The piston consists of the ClyA nanopore, dsDNA,
  ssDNA and neutravidin, all modeled using Lennard-Jones beads. ClyA is comprised of
  three open cylinders for which the cross-section is shown regarding visualization
  purposes.  (b) Typical configurations of the rotaxane-ds and -ss in absence of an
  applied bias. The ssDNA overhang of rotaxane-ds is indicated
  with “ss”  and the interface between ssDNA and dsDNA in rotaxane-ss is indicated with
  an arrow. Images taken from reference \cite{Bayoumi21}}}
  \label{fig:CG-piston}
  \end{centering}
\end{figure}
