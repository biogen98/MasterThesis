...
\begin{figure}[ht]
  ...
  \centering
  \vspace{-0.9cm}
  \includegraphics[width=.9\linewidth,valign=t]{Figures/ballnstick2.png}
  \end{subfigure}%
  \adjustbox{minipage=1.3em,valign=t}{\subcaption{}\label{sfig:testa}}%
  \begin{subfigure}[t]{\dimexpr.35\linewidth-1.3em\relax}
  \centering
  ...
  \centering
  \vspace{-0.5cm}
  \includegraphics[width=.65\linewidth,valign=t]{Figures/beadSpring.png}
  \end{subfigure}
...
%   \centering
%   \vspace{-1.7cm}
%   \includegraphics[width=.65\linewidth,valign=t]{Figures/ballnstick2.png}
%   \end{subfigure}%
%   \adjustbox{minipage=1.3em,valign=t}{\subcaption{}\label{sfig:testa}}%
%   \begin{subfigure}[t]{\dimexpr.35\linewidth-1.3em\relax}
%   \centering
