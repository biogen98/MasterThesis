...
project was to develop a coarse-grained model of DNA, that could be used in DNA
technology. For the development of this technology a model was needed that
...
data to calibrate the interactions, characterising their approach as "top down"
...
\begin{wrapfigure}[15]{r}{0.5\textwidth}
  ...
  \end{center}
  \caption[Structure of the OxDNA model]{{\small Structure of the OxDNA model with the
  different interactions. Figure was taken from reference \cite{Ouldridge2010}.}}
\end{wrapfigure}
...
where the double helix structure is explicitly constructed. This
