...
% \begin{wrapfigure}[36]{r}{0.2\textwidth}
%   \begin{center}
...
\begin{figure}[h!]
   ...
   DNA.]{\linespread{0.816}{\small Double helical structure of
   ...
   hydrogen bonds. Image was made in Blender, using generated PDB data.\cite{blender}}}
   \label{fig:DNA}
\end{figure}
